...
class MovieViewModel(application: Application): AndroidViewModel(application){
    ...
    fun refreshMovies(page: Int){
        ...
        disposable =
            RetrofitService.create("https://api.themoviedb.org/3/").getNowPlaying("276dfe83a1f42c1a4e5bffe279982a6f",page).subscribeOn(
    ...
    fun showLiked(id: Long, liked: Boolean) = scope.launch(Dispatchers.IO)
    {
        repository.showiked(id, liked)
    }
